                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                            ...
                            <div class="ml-4 text-md tracking-wide font-semibold w-40">
                                <router-link to="https://mail.google.com/mail/u/0/#inbox?compose=new">suman767651@gmail.com</router-link>
                            </div>
                        </div>
                    </div>
                    ...
                    <form  id="contactFrom" method="post" class="p-6 flex flex-col justify-center">
                        ...
                        <div class="flex flex-col gap-4 p-5">
                            ...
                            <div class="flex space-x-4">
                                <button @onclick="success()"><router-link class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" to="/Contact">
                                    Submit</router-link>
                                </button>
