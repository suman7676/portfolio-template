<template>
    <div class="w-screen  mx-auto p-6 lg:px-30 sm:px-8 bg-slate-200 dark:bg-slate-800">
        <div
            class="my-4 pb-8 flex items-center before:mt-0.5  before:border-t before:border-neutral-300 after:mt-0.5  after:border-t after:border-neutral-300">
